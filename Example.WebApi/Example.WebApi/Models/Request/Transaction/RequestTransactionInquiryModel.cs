...
{
    public class RequestTransactionInquiryModel
    {
        public string customerID { get; set; }
        public string email { get; set; }

        public class RequestTransactionInquiryModelValidator : AbstractValidator<RequestTransactionInquiryModel>
        {
            public RequestTransactionInquiryModelValidator()
            {
            ...
            private bool ValidInputAtLeast(RequestTransactionInquiryModel model)
            {
